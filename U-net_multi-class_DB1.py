...
data_gen_args = dict(rotation_range=0.3,
                    ...
                    vertical_flip=True,
                    fill_mode='nearest')
PATH='/home/lior.go@staff.technion.ac.il/PycharmProjects/pythonProject/208_multiclass/new_data_biopsy_208/train/'
...
model.fit(data_gen,steps_per_epoch=20,epochs=200,verbose=1)

#Step 1: Run model on test images and save the images
#number of test images
n_i=len(os.listdir('/home/lior.go@staff.technion.ac.il/PycharmProjects/pythonProject/208_multiclass/new_data_biopsy_208/test/images/'))
#Call test generator
test_gen = testGenerator('/home/lior.go@staff.technion.ac.il/PycharmProjects/pythonProject/208_multiclass/new_data_biopsy_208/test/images/')
#Return model outcome for each test image
results = model.predict_generator(test_gen,n_i,verbose=1)

SaveResultwImage('/home/lior.go@staff.technion.ac.il/PycharmProjects/pythonProject/208_multiclass/new_data_biopsy_208/test/images/',PATH+'pred/',results)
